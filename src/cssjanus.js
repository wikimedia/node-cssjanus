...
function CSSJanus() {
	...
	var
		...
		mathExpressionPattern = '(?:[\\t ]*\\(?[\\t ]*' + signedQuantSimplePattern + '[\\t ]*' + mathOperatorsPattern + '[\\t ]*' + signedQuantSimplePattern + mathExpressionRepeatePattern + '[\\t ]*\\)?)',
		calcPattern = '(?:calc\\((?:' + mathExpressionPattern + ')+[\\t ]*\\))',
