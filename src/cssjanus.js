...
function CSSJanus() {
	...
	var
		...
		mathExpressionExtendPattern = '(?:[\\t ]*' + mathOperatorsPattern + '[\\t ]*' + signedQuantSimplePattern + ')*',
		...
		calcPattern = '(?:calc\\((?:' + bracedMathExpressionPattern + '|' + mathExpressionPattern + '|' + mathExpressionExtendPattern + ')+[\\t ]*\\))',
