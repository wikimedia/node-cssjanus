...
function CSSJanus() {
	...
	var
		...
		mathExpressionRepeatePattern = '(?:[\\t ]*' + mathOperatorsPattern + '[\\t ]*' + signedQuantSimplePattern + ')*',
		mathExpressionPattern = '(?:' + signedQuantSimplePattern + '[\\t ]*' + mathOperatorsPattern + '[\\t ]*' + signedQuantSimplePattern + ')',
		bracedMathExpressionPattern = '(?:[\\t ]*\\(?[\\t ]*' + mathExpressionPattern + '[\\t ]*\\)?[\\t ]*)',
		calcPattern = '(?:calc\\((?:' + bracedMathExpressionPattern + '|' + mathExpressionPattern + '|' + mathExpressionRepeatePattern + ')+[\\t ]*\\))',
